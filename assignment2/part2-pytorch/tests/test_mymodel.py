...
class TestMyModel(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.err = None
        if not pathlib.Path.exists(basedir / "checkpoints/mymodel.pth"):
            cls.err = "Could not find model file at checkpoints/mymodel.pth. Train the model first to generate a checkpoint file"
            return
